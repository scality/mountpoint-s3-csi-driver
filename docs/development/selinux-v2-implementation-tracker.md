...
| 1 | Create upgrade test directory structure | None | Foundation for upgrade testing | [upgrade-testing-plan.md#pr-1](upgrade-testing-implementation-plan.md#pr-1-create-upgrade-test-directory-structure) | |
| 2 | Add basic logging helpers | None | Consistent test output | [upgrade-testing-plan.md#pr-2](upgrade-testing-implementation-plan.md#pr-2-add-basic-logging-helpers) | |
