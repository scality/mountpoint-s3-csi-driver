...
const (
	LabelHeadroomForPod    = "s3.csi.scality.com/headroom-for-pod"
	LabelHeadroomForVolume = "s3.csi.scality.com/headroom-for-volume"
)

// Labels populated on Workload Pods requesting Headroom Pods.
const (
	LabelHeadroomForWorkload = "s3.csi.scality.com/headroom-for-workload"
)
...
const SchedulingGateReserveHeadroomForMountpointPod = "s3.csi.scality.com/reserve-headroom-for-mppod"
